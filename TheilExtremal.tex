...
\begin{figure}
\centering
\makebox[\textwidth][c]{\includegraphics[width=1\textwidth, natwidth=600, natheight=127, width=12cm, height=3cm]{Tool.png}}%
%\hbox{\includegraphics [width=10cm, height=3cm, natwidth=600, natheight=127] {Tool.png}} 
%\includegraphics[width=0.7\textwidth, natwidth=300, natheight=70]{Tool.png}
